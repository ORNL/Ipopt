...
ESymSolverStatus KLUSolverInterface::MultiSolve(bool new_matrix, const Index *ia, const Index *ja, Index nrhs,
                                                Number *rhs_vals, bool check_NegEVals, Index numberOfNegEVals)
{
   ...
   printf("KLU MultiSolve Called\n");
    ...
    write_CSR_matrix_rhs(Ap_, Ai_, val_, rhs_vals, ndim_, nonzeros_, "KLU",
                         seq);
    seq++;
    if (HaveIpData())
    {
